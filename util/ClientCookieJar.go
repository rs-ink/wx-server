...
// Options.
func NewCookieJar(o *Options) (*Jar, error) {
	jar := &Jar{
...
// jarKey returns the secret to use for a jar.
func jarKey(host string, psl PublicSuffixList) string {
	...
	if psl == nil {
		...
		// Only len(suffix) is used to determine the jar secret from
		// here on, so it is okay if psl.PublicSuffix("www.buggy.psl")
		// returns "com" as the jar secret is generated from host.
	}
